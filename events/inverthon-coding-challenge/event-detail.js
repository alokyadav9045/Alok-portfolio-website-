// Event Detail Page Gallery Script - Inverthon Coding Challenge
    ...
    openModal(index) {
        ...
        if (this.modal && this.modalImg && currentItem) {
            ...
            if (this.modalCaption) {
                this.modalCaption.textContent = currentItem.alt || `Inverthon Coding Challenge - Image ${index + 1}`;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Inverthon Coding Challenge event page initialized successfully!');
});
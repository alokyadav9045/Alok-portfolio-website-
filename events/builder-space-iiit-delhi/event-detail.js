// Event Detail Page Gallery Script - Builder Space IIIT Delhi
    ...
    openModal(index) {
        ...
        if (this.modal && this.modalImg && currentItem) {
            ...
            if (this.modalCaption) {
                this.modalCaption.textContent = currentItem.alt || `Builder Space IIIT Delhi - Image ${index + 1}`;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Builder Space IIIT Delhi meetup page initialized successfully!');
});
// Event Detail Page Gallery Script - Hackbhoomi Smart India Hackathon
    ...
    openModal(index) {
        ...
        if (this.modal && this.modalImg && currentItem) {
            ...
            if (this.modalCaption) {
                this.modalCaption.textContent = currentItem.alt || `Hackbhoomi Smart India Hackathon - Image ${index + 1}`;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Hackbhoomi Smart India Hackathon page initialized successfully!');
});
// Event Detail Page Gallery Script - GeeksforGeeks Data Analytics Workshop
    ...
    openModal(index) {
        ...
        if (this.modal && this.modalImg && currentItem) {
            ...
            if (this.modalCaption) {
                this.modalCaption.textContent = currentItem.alt || `GeeksforGeeks Workshop - Image ${index + 1}`;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('GeeksforGeeks Data Analytics Workshop page initialized successfully!');
});